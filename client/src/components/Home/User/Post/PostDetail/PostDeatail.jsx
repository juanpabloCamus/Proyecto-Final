...
function PostDetail() {
  ...
  if (userLocalStorage.profileType[0] === "company") {
    if (company_accounts !== undefined) {
      if (company_accounts[0].id !== userLocalStorage.id)
        return (
    ...
    company_accounts ? (
      <div className={styles.pageContainer}>
        ...
        <div className={styles.companyInfoContainer}>
          ...
          <Link to={`/home/company/${company_accounts[0].id}`} onClick={window.scrollTo(0,0)}>
        ...
        {company_accounts[0].id === userLocalStorage.id &&
        userLocalStorage.profileType[0] === "company" ? null : (
